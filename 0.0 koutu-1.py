...
class Seal:
    ...
    def extension_img(self):
        ...
        resultprint = cv2.resize(print5, (240, 240))
 
        cv2.imwrite(r'C:\\Users\\Administrator\\Pictures\\{}_result.png'.format(self.file_name), resultprint)
        im2 = cv2.hstack((self.image,resultprint))
        cv2.imshow("org_sign",im2)
 
if __name__ == '__main__':
    s = Seal(r"C:\Users\Administrator\Pictures\sign-1.jpg")
    s.extension_img()